...
const getHouses = (arr) => {
  ...
  arr.forEach((character) => {
    Object.keys(character).forEach((key) => {
      if (key === 'house') houses.push(character[key]);
    })
  })
  return houses;
};
...
const totalCharacters = (arr) => {
  ...
  arr.forEach((character) => {
    characterCount++;
    if (character.spouse) characterCount++;
    if (character.children.length !== 0) characterCount += character.children.length;
  })
...
const houseSize = (arr) => {
  ...
  arr.forEach((character) => {
    let houseSize = 0;
    houseSize++;
    if (character.spouse) houseSize++;
    if (character.children.length !== 0) houseSize += character.children.length;
...
const houseSurvivors = (arr) => {
  ...
  arr.forEach((character) => {
    let houseSize = 0;
    houseSize++;
    if (character.spouse && !deceasedSpouses.includes(character.spouse)) houseSize++;
    if (character.children.length !== 0) houseSize += character.children.length;
